...
public class WelcomeServletTwo extends HttpServlet{
	...
	public void doGet(HttpServletRequest rq, HttpServletResponse rs)throws IOException, ServletException{
		...
		out.println("<html>");
		out.println("<head><title>Welcome Servlet Two</title></head>");
		out.println("<body>");
		out.println("<h1>Welcome Servlet Two</h1>");
		out.println("<hr>");
		...
		out.println("<a href='/smallapp'>Back to homepage</a>");		out.println("</body></html>");
